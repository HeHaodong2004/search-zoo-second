...
class PathPlanningMaskEnv(gym.Env):
    ...
    def _get_obs(self) -> Dict:
        ...
        # history
        hist = np.array(list(self.action_history), dtype=np.int64)
        return {'scan': scans, 'goal_vec': goal_vec, 'action_mask': self.action_masks(), 'hist': hist}
